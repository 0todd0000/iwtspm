...
ax.text(0.8, 0.5, r'$\mathcal{D}_0$', color='b', ha='center')
ax.text(0.2, 0.5, r'$\mathcal{D}_0$', color='b', ha='center')
ax.text(0.5, 0.6, r'$\mathcal{D}_1$', color='b', ha='center')
ax.text(0.5, 0.82, 'Signal width', color='r', ha='center')
ax.text(-0.03, 0.92, 'Step width (0.05)', color='g', va='center')
ax.text(0.77, 0.92, 'Step width (0.05)', color='g', va='center')
ax.plot([0, q10], [0.48]*2, color='b', lw=2)
ax.plot([q11, 1], [0.48]*2, color='b', lw=2)
ax.plot([q10,q11], [0.58]*2, color='b', lw=2)
ax.plot([q00,q01], [0.79]*2, color='r', lw=2)
ax.plot([q00, q10], [0.92]*2, color='g', lw=4)
ax.plot([q01, q11], [0.92]*2, color='g', lw=4)
